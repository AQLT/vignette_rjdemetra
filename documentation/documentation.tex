...
industrial production index of the euro area (EA19):
...
Ouvrir sur les possibilités que ça apporte par rapport aux autres
package \citep[\citet{x12}]{seasonal}, notamment en production,
l'avantage que ce soit validé par Eurostat, etc.

\pkg{ggdemetra} \citep{ggdemetra}, \pkg{rjdqa} \citep{rjdqa},
\pkg{persephone} \citep{persephone}
