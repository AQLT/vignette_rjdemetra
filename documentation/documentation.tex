...
recommended to start their analysis with one of them. We will follow
also this approach and later it will be presented how to modify model
specifications, including the possibility to incorprate user-defined
regressors (see section 5).
...
specifications. Here the outcome will be described in detail.
...
\caption{\label{tab:unnamed-chunk-5}\label{tab:obj_tab}SA object structure}\\
\toprule
