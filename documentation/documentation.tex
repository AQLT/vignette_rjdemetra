...
\hypertarget{using-the-r-package-rjdemetra}{%
\subsection{Using the R package
RJDemetra}\label{using-the-r-package-rjdemetra}}
...
\caption{\label{tab:unnamed-chunk-2}SA object structure}\\
\toprule
...
The model specification can be defined from an exisitng model
...
\hypertarget{gestion-dun-workspace}{%
\section{Gestion d'un workspace}\label{gestion-dun-workspace}}
