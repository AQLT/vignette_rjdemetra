...
adjustment software \proglang{JDemetra+}. \pkg{RJDemetra} uses Java
libraries of \proglang{JDemetra+}, thus it relies on the \pkg{rJava}
...
\item
  acces to all the output available in \proglang{JDemetra+} (section
  \ref{sa-obj-struc});\\
\item
