...
The pre-defined specifications correspond to most commonly used specifications and users are recommended to start their analysis with one of them. We will follow also this approach and later it will be presented how to modify model specifications, including the possibility to incorprate user-defined regressors (see section 5).   
...
In the previous section it was presented how to run a RegARIMA and complete seasonal adjustment estimation with pre-defined model specifications. Here the outcome will be described in detail. 
