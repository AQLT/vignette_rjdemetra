...
Almost all the specification variables available in JDemetra+ can be used in \pkg{RJDemetra}[^3]. For more details see the help of the corresponding function or the documentation of JDemetra+.
